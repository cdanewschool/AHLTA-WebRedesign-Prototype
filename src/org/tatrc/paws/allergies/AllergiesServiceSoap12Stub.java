/**
 * AllergiesServiceSoap12Stub.java
 *
...
public class AllergiesServiceSoap12Stub extends org.apache.axis.client.Stub implements org.tatrc.paws.allergies.AllergiesServiceSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://paws.tatrc.org/", "ArrayOfAllergy"));
        oper.setReturnClass(org.tatrc.paws.allergies.Allergy[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://paws.tatrc.org/", "FetchAllergiesResult"));
        param = oper.getReturnParamDesc();
        param.setItemQName(new javax.xml.namespace.QName("http://paws.tatrc.org/", "Allergy"));
    ...
    public AllergiesServiceSoap12Stub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public AllergiesServiceSoap12Stub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public AllergiesServiceSoap12Stub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://paws.tatrc.org/", "Allergy");
            cachedSerQNames.add(qName);
            cls = org.tatrc.paws.allergies.Allergy.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://paws.tatrc.org/", "ArrayOfAllergy");
            cachedSerQNames.add(qName);
            cls = org.tatrc.paws.allergies.Allergy[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://paws.tatrc.org/", "Allergy");
            qName2 = new javax.xml.namespace.QName("http://paws.tatrc.org/", "Allergy");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("http://paws.tatrc.org/", "ArrayOfConceptValue");
            cachedSerQNames.add(qName);
            cls = org.tatrc.paws.allergies.ConceptValue[].class;
            cachedSerClasses.add(cls);
    ...
    public org.tatrc.paws.allergies.Allergy[] fetchAllergies(java.lang.String application, java.lang.String username, java.lang.String unitnumber) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://paws.tatrc.org/FetchAllergies");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP12_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://paws.tatrc.org/", "FetchAllergies"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {application, username, unitnumber});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (org.tatrc.paws.allergies.Allergy[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (org.tatrc.paws.allergies.Allergy[]) org.apache.axis.utils.JavaUtils.convert(_resp, org.tatrc.paws.allergies.Allergy[].class);
            }
        }
