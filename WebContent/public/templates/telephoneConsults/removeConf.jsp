<form style="margin: 5px 20px 5px 20px; ">
	<div style="margin: 5px 20px 5px 20px; ">The selected telephone consult has been canceled.</div>
	<div class="rela"  style="width: 100px; left: 110px; " >
		<input id="btnOk" type="button" class="rela textButton " value="OK" 
			...
			onmouseup="teleConActions.doneRemove(event) ; return actionBttns.mouseup(event, 'btnOk');" 
		/> 
	</div>
</form>