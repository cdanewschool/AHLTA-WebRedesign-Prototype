	...
	builder:function () {
		...
		/*** Public Static Methods ***/
			...
			var
				...
				_getStyle =
				_package.getStyleAttribute = // DEPRECATED (see documentation)
				_package.getStyle = function (_node,_property) {
					var _value = '';
		...
		/*** wire up window events to fire events on window event vehicle ***/
			...
			function _wireUpWindowEvent (_windowEventName) {
				...
				window [_windowEventPropertyName] = function (_event) {
					...
					_oldWindowEventHandler.call (window,_event || (_event = event));
		...
		/*?
			Deprecated Features
				Uize.Node.getStyleAttribute (static method) -- DEPRECATED 2009-03-26
					This method has been deprecated in favor of the more concisely named =Uize.Node.getStyle= static method.
