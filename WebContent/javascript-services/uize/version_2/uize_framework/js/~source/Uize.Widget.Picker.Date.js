	...
	builder:function (_superclass) {
					...
					/*?
						Set-get Properties
							displayFormat
								...
								The default =valueFormatter= set for this class uses the =Uize.Date.format= static method of the =Uize.Date= module to format date values. Formatting options supported by the =displayFormat= property correspond to those supported by the =formatSTR= parameter of the =Uize.Date.format= method. If you specify your own value for the =valueFormatter= set-get property that is inherited from the =Uize.Widget.Picker= base class, then the value of the =displayFormat= property will only be applicable if your custom value formatter actually uses it.
		...
		/*** Override Initial Values for Inherited Set-Get Properties ***/
			_class.set ({
				...
				value:null,
				valueFormatter:function (_value) {return Uize.Date.format (_value,this._displayFormat)}
			});
