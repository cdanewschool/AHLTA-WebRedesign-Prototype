	...
	builder:function (_superclass) {
		...
		/*** Register Properties ***/
			_class.registerProperties ({
				...
				_properties:{
					name:'properties',
					onChange:function () {this.set ({_title:this._properties.title})}
					/*?
						Set-get Properties
							properties
								An object, acting as a "bucket" for additional data that may be associated to an instance.

								The data in the =properties= set-get property is used by the =getPropertyForItems= and =getPropertyForSelected= instance methods of the =Uize.Widget.Collection= class. When the value of the =properties= set-get property is changed, the value of the =title= set-get property is set from the "title" property of the =properties= object.
