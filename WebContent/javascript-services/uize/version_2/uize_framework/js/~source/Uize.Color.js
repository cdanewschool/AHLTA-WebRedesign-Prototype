...
Uize.module ({
	...
	builder:function () {
		...
		/*** Public Static Properties ***/
			_object.RgbColor = _object;

		/*** Public Instance Methods ***/
			_objectPrototype.from = _objectPrototype.setColor = _objectPrototype.setHex = function (_color) {
				var _this = this;
			...
			_objectPrototype.toHex = function () {return this.to ('hex')}; // DEPRECATED (see documentation)
		...
		/*** Public Static Methods ***/
			...
			_object.hexStrToRgb = function (_color) { // DEPRECATED (see documentation)
				return _object.to (_color,'RGB object')
			};

			_object.rgbToHexStr = function (_color) { // DEPRECATED (see documentation)
				return _object.to (arguments.length == 3 ? arguments : _color)
			};

			_object.rgbToStyleStr = function (_color) { // DEPRECATED (see documentation)
				return _object.to (_color,'RGB string')
			};

			_object.from = _object.rgbFromStyleStr = function () {
		...
		/*?
			Deprecated Features
				mix -- DEPRECATED 2009-04-18
					This instance method has been deprecated in favor of the better named and more versatile =blend= instance method that is implemented in the =Uize.Color.xUtil= extension module.

					INSTEAD OF...
					...................................................
					myRgbColor.mix (rgbColor1,rgbColor2,blendFRACTION);
					...................................................

					USE...
					.....................................................
					myRgbColor.blend (rgbColor1,rgbColor2,blendFRACTION);
					.....................................................

					While the deprecated =mix= instance method of the deprecated =Uize.Color.RgbColor= object required colors to be specified as objects containing =red=, =green=, and =blue= properties, the =blend= method of the =Uize.Color= object supports a wide variety of different `Color Encodings`. Also, colors being blended do not have to be in the =sRGB= color space, but may be in any of the supported `Color Spaces`.

				setColor -- DEPRECATED 2009-04-19
					This method has been deprecated in favor of the more versatile =from= instance method that offers many more ways for colors to be specified.

					INSTEAD OF...
					.................................
					colorOBJ.setColor (colorANYTYPE);
					.................................

					USE...
					.............................
					colorOBJ.from (colorANYTYPE);
					.............................

					The =from= instance method of the =Uize.Color= object supports a much wider variety of `Color Encodings` than the deprecated =setColor= method.

				setHex -- DEPRECATED 2009-04-16
					This method has been deprecated and has been replaced by the more versatile =from= instance method that offers many more ways for colors to be specified.

					INSTEAD OF...
					............................
					colorOBJ.setHex (hexRgbSTR);
					............................

					USE...
					..........................
					colorOBJ.from (hexRgbSTR);
					..........................

					Unlike the deprecated =setHex= method, the =from= method supports a wide variety of different `Color Encodings`.

				toHex -- DEPRECATED 2009-04-19
					This instance method has been deprecated in favor of the more versatile =to= instance method.

					INSTEAD OF...
					..............................
					hexRgbSTR = colorOBJ.toHex ();
					..............................

					USE...
					................................
					hexRgbSTR = colorOBJ.to ('hex');
					................................

					Unlike the deprecated =toHex= method, the =to= method supports a wide variety of different `Color Encodings`.

				Uize.Color.blendHex -- DEPRECATED 2009-04-20
					This method has been deprecated in favor of the more versatile =Uize.Color.blend= static method that is implemented in the =Uize.Color.xUtil= extension module.

					INSTEAD OF...
					............................................................................
					colorHexSTR = Uize.Color.blendHex (color1HexSTR,color2HexSTR,blendFRACTION);
					............................................................................

					USE...
					.........................................................................
					colorHexSTR = Uize.Color.blend (color1HexSTR,color2HexSTR,blendFRACTION);
					.........................................................................

					Unlike the deprecated =Uize.Color.blendHex= static method, the =Uize.Color.blend= static method supports a wide variety of different `Color Encodings`.

				Uize.Color.hexStrToRgb -- DEPRECATED 2009-04-20
					This method has been deprecated in favor of the more versatile =Uize.Color.to= static method.

					INSTEAD OF...
					............................................
					rgbOBJ = Uize.Color.hexStrToRgb (hexRgbSTR);
					............................................

					USE...
					................................................
					rgbOBJ = Uize.Color.to (hexRgbSTR,'RGB object');
					................................................

					The =Uize.Color.to= static method allows source color to be specified in a wide variety of different `Color Encodings`, and also allows the source color to be encoded to any of the supported encodings.

				Uize.Color.mixColors -- MIGRATED 2009-04-19
					This static method has been migrated to the =Uize.Color.xUtil= extension module, which implements it as =Uize.Color.mix=.

					INSTEAD OF...
					.......................................................
					Uize.Color.mixColors (color1,color2,color3,...,colorN);
					.......................................................

					USE...
					...................................................
					Uize.Color.mix ([color1,color2,color3,...,colorN]);
					...................................................

					While the discontinued =Uize.Color.mixColors= static method required colors to be specified as objects containing =red=, =green=, and =blue= properties, the =Uize.Color.mix= methods supports a wide variety of different `Color Encodings`. Also, colors being mixed do not have to be in the =sRGB= color space, but may be in any of the supported `Color Spaces`.

				Uize.Color.RgbColor -- DEPRECATED 2009-04-17
					This object has been deprecated in favor of the =Uize.Color= object.

					INSTEAD OF...
					............................................................
					myColor = new Uize.Color.RgbColor (redINT,greenINT,blueINT);
					............................................................

					USE...
					...................................................
					myColor = new Uize.Color (redINT,greenINT,blueINT);
					...................................................

					The `Constructor` of the =Uize.Color= object lets you specify initial color in a much wider variety of `Color Encodings` than the constructor of the deprecated =Uize.Color.RgbColor= object.

				Uize.Color.rgbFromStyleStr -- DEPRECATED 2009-04-02
					This method has been deprecated and has been replaced by an improved version of the =Uize.Color= object with a more flexible `Constructor` that allows initial color to be specified in a wide variety of ways.

					INSTEAD OF...
					......................................................
					colorOBJ = Uize.Color.rgbFromStyleStr (styleColorSTR);
					......................................................

					USE...
					..........................................
					colorOBJ = new Uize.Color (styleColorSTR);
					..........................................

					In addition to using the `Constructor`, there are two other methods for creating instances of the =Uize.Color= object, where you can specify the initial color in any of the many supported `Color Encodings` (see the section `Creating Instances`).

				Uize.Color.rgbToHexStr -- DEPRECATED 2009-04-20
					This method has been deprecated in favor of the more versatile =Uize.Color.to= static method.

					INSTEAD OF...
					............................................
					hexRgbSTR = Uize.Color.rgbToHexStr (rgbOBJ);
					............................................

					USE...
					.........................................
					hexRgbSTR = Uize.Color.to (rgbOBJ,'hex');
					.........................................

					Or, for the variation of the deprecated =Uize.Color.rgbToHexStr= method that accepted the three parameters =redINT=, =greenINT=, and =blueINT=...

					INSTEAD OF...
					.............................................................
					hexRgbSTR = Uize.Color.rgbToHexStr (redINT,greenINT,blueINT);
					.............................................................

					USE...
					............................................................
					hexRgbSTR = Uize.Color.to ([redINT,greenINT,blueINT],'hex');
					............................................................

					The =Uize.Color.to= static method allows source color to be specified in a wide variety of different `Color Encodings`, and also allows the source color to be encoded to any of the supported encodings.

				Uize.Color.rgbToStyleStr -- DEPRECATED 2009-04-20
					This static method has been deprecated in favor of the more versatile =Uize.Color.to= static method.

					INSTEAD OF...
					.......................................................
					rgbColorStyleSTR = Uize.Color.rgbToStyleStr (colorOBJ);
					.......................................................

					USE...
					.........................................................
					rgbColorStyleSTR = Uize.Color.to (colorOBJ,'RGB string');
					.........................................................
		*/
