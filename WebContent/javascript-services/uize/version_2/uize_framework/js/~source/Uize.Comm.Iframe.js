...
Uize.module ({
	...
	builder:function (_superclass) {
			...
			_classPrototype.performRequest = function (_request,_callback) {
				...
				handleResponse = function (_responseResult) {
					...
					navigator.appName == 'Microsoft Internet Explorer' &&
						_iframe.contentWindow.history.go (-1)
					;
					_callback ();
				};
		...
		/*** Initialization ***/
			/*** put the IFRAME tag into the page ***/
				var _iframeId = _classPrototype.iframeId = 'Uize_Comm_Iframe_iframe' + Uize.Url.getCacheDefeatStr ();
