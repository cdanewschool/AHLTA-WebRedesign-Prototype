			...
			_classPrototype.wireUi = function () {
				...
				if (!_this.isWired) {
					...
					function _pixelsToScale(_pixels) {
						...
						;
						return _pixels * (1 - _orientationNo * 2) * (_scaleMax - _scaleMin)
							...
							function (_event) {
								...
								_this._setValueInDrag (
									_valueFunc(
										...
										_pixelsToScale ((_orientationNo ? _event.clientY + _getScroll ('Top') : _event.clientX + _getScroll ('Left')) - _knobDims [_orientationNo] / 2 * (1 - _orientationNo * 2) - [_trackCoords.x,_trackCoords.bottom] [_orientationNo])
									)
								);
								return _drag.mousedown (_event);
							}
						);
