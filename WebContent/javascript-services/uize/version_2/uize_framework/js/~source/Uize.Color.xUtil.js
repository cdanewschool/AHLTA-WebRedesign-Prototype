...
Uize.module ({
	...
	builder:function (_object) {
		...
		/*** Public Instance Methods ***/
			_objectPrototype.blend = _objectPrototype.mix = function (_color1,_color2,_blendAmount) {
		...
		/*** Public Static Methods ***/
			_object.blend = _object.blendHex = function (_color1,_color2,_blendAmount,_encoding) {
