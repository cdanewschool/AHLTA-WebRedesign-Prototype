			...
			_package.process = function (input) {
				var output = [];
					...
					var
						...
						_tourExamplePageStyle = 'width:' + 100 / _tourExamplesLength + '%;',
				...
				output.push ('\r\n	<a href="',_getExamplePageLink (_tourExample),'" class="tourPage',_tourExampleNo == _pageNo ? ' tourCurrentPage' : '','" style="',_tourExamplePageStyle,'"></a>');
				 } 
				output.push ('\r\n</div>\r\n');
